...
if (isset($_POST['id']) AND isset($_POST['codigo']) AND isset($_POST['descripcion']) AND isset($_POST['ni']) AND isset($_POST['ns'])) 
{
...
if (strlen($id)>0 AND strlen($codigo)>0 AND strlen($descripcion)>0 AND strlen($ni) AND strlen($ns)) 
{
