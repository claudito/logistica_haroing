...
public function agregar()
{
   try {
    ...
    $query     = "SELECT * FROM mov_guia WHERE numero=:numero AND tipo=:tipo";
    ...
    {
     $query     = "INSERT INTO mov_guia(numero,alm,tran,doc_ref,num_ref,id_usuario,id_proveedor,fecha_inicio,fecha_fin,comentario,centro_costo,ot,area,tipo) VALUES (:numero,:alm,:tran,:doc_ref,:num_ref,:id_usuario,:id_proveedor,:fecha_inicio,:fecha_fin,:comentario,:centro_costo,:ot,:area,:tipo)";
...
public function eliminar($id)
{
   try {
    $modelo    = new Conexion();
    $conexion  = $modelo->get_conexion();
     $query     = "DELETE FROM mov_guia WHERE id=:id";
    $statement = $conexion->prepare($query);
...
public function actualizar($id)
{
   ...
   try {
    $modelo    = new Conexion();
    $conexion  = $modelo->get_conexion();
    $query     = "UPDATE  mov_guia  SET  tran=:tran,doc_ref=:doc_ref,num_ref=:num_ref,id_proveedor=:id_proveedor,fecha_inicio=:fecha_inicio,fecha_fin=:fecha_fin,comentario=:comentario,centro_costo=:centro_costo,ot=:ot,area=:area,estado=:estado WHERE  numero=:id AND tipo=:tipo";
