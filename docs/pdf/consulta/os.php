...
$firma_1 = $objeto->estado_firma('OS',$_GET['id'],'1','id_usuario');
$firma_1 = (!empty($firma_1)) ? $firma_1 : 0 ;

$firma_2 = $objeto->estado_firma('OS',$_GET['id'],'2','id_usuario');
$firma_2 = (!empty($firma_2)) ? $firma_2 : 0 ;

$firma_3 = $objeto->estado_firma('OS',$_GET['id'],'3','id_usuario');
