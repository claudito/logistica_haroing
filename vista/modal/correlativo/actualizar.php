...
<div class="form-group">
<label>NÚMERO</label>
<input type="number" name="numero"  min="0" id=""  required="" class="form-control" maxlength="100" 
 onchange="Mayusculas(this)" value="<?php echo $objeto->consulta($id,'numero'); ?>" autocomplete="off">
</div>
