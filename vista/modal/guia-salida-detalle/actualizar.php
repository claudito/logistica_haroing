...
<label>CÓDIGO</label>
<input type="text" name="codigo" class="form-control" value="<?php echo $movalmdet_salida->consulta($id,'codigo_articulo').' - '.$movalmdet_salida->consulta($id,'descripcion_articulo'); ?>" readonly>
</div>
